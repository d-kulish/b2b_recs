#!/bin/bash
# Deploy the platform Django app to Cloud Run.
# This script deploys only the authenticated platform service.
...
echo "================================"
echo "Platform Cloud Run Deployment"
echo "================================"
...
echo "Step 1/4: Building platform Docker image..."
...
echo "2. Verify $SERVICE_URL redirects to /dashboard/"
echo "3. Use ./website/deploy_website.sh when you want to ship website changes"
echo ""
