...
│                                                                                          │
│  ┌────────────────────────────────┐ ┌────────┐ ┌────────┐ ┌────────┐ ┌────────┐         │
│  │ SERVING ENDPOINTS              │ │ 47.3K  │ │ 142ms  │ │ 0.04%  │ │   8    │         │
│  │ [🚀] [4    ] [0   ] [4     ]  │ │Requests│ │Latency │ │ Errors │ │Peak/Avg│         │
│  │      TOTAL   ACTIVE  INACTIVE │ │  (7D)  │ │ (P95)  │ │  Rate  │ │        │         │
│  └────────────────────────────────┘ └────────┘ └────────┘ └────────┘ └────────┘         │
│                                                                                          │
│  ┌─────────────────────────┐ ┌─────────────────────────┐ ┌─────────────────────────────┐│
...
The KPI section uses a **single-row layout** with all 7 KPIs inline:

#### Serving Endpoints Group (left)
Contains endpoint status metrics in a bordered container:
...
#### Performance KPI Cards (right, inline)
Four individual KPI cards displayed inline after the Serving Endpoints group:
...
```css
/* KPI Row: Single row with Serving Endpoints group + 4 inline KPIs */
...
|------------|---------|--------|--------|
| > 1400px | Single row: all 7 KPIs inline | 3 columns | 2 columns |
| 1200-1400px | Wrap: Serving Endpoints full width, 4 KPIs below (25% each) | 2 columns | 1 column |
| 900-1200px | Wrap: Serving Endpoints full width, 4 KPIs (50% each) | 2 columns | 1 column |
| < 768px | Stacked: all vertical | 1 column | 1 column |
