        ...
        if model_type == 'ranking':
            ...
            for i, item in enumerate(experiments_with_metrics[:limit]):
                ...
                configurations.append({
                    ...
                    'dataset_id': qt.feature_config.dataset.id if qt.feature_config and qt.feature_config.dataset else None,
                    ...
                    'optimizer': qt.optimizer,
                    'top_k': qt.top_k,
                    'retrieval_algorithm': qt.retrieval_algorithm,
