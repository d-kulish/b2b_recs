"""
Management command to create/delete a Cloud Scheduler job for daily billing snapshot collection.

Usage:
    # Create the scheduler job
    python manage.py setup_billing_scheduler --url https://your-app.run.app
...
JOB_NAME = 'collect-billing-snapshots'
SCHEDULE = '0 5 * * *'  # Daily at 05:00 UTC (after metrics 02:00, cleanup 03:00, orphans 04:00)


class Command(BaseCommand):
    help = 'Create or delete a Cloud Scheduler job for daily billing snapshot collection'
    ...
    def handle(self, *args, **options):
        ...
        webhook_url = f"{base_url}/api/system/collect-billing-webhook/"
        ...
        job = scheduler_v1.Job(
            name=full_job_name,
            description='Daily billing snapshot collection from GCP Billing Export',
            schedule=SCHEDULE,
            time_zone='UTC',
        ...
        try:
            try:
                ...
                self.stdout.write(self.style.SUCCESS(
                    ...
                    f'  Schedule: {SCHEDULE} (daily at 05:00 UTC)\n'
