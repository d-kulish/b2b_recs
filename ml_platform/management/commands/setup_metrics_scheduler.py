"""
Management command to create/delete a Cloud Scheduler job for daily metrics collection.

Usage:
    # Create the scheduler job
    python manage.py setup_metrics_scheduler --url https://your-app.run.app

    # Delete the scheduler job
    python manage.py setup_metrics_scheduler --delete
"""
import os
import json
import logging
...
class Command(BaseCommand):
    help = 'Create or delete a Cloud Scheduler job for daily resource metrics collection'
    ...
    def handle(self, *args, **options):
        ...
        webhook_url = f"{base_url}/api/system/collect-metrics-webhook/"
        ...
        try:
            ...
            try:
                ...
                self.stdout.write(self.style.SUCCESS(
                    ...
                    f'  Schedule: {SCHEDULE} (daily at 02:00 UTC)\n'
