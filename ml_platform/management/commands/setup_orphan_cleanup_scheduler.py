"""
Management command to create/delete a Cloud Scheduler job for daily orphaned RegisteredModel cleanup.

Usage:
    # Create the scheduler job
    python manage.py setup_orphan_cleanup_scheduler --url https://your-app.run.app

    # Delete the scheduler job
    python manage.py setup_orphan_cleanup_scheduler --delete
"""
import os
import json
import logging
...
SCHEDULE = '0 4 * * *'  # Daily at 04:00 UTC (after 03:00 GCS cleanup)


class Command(BaseCommand):
    help = 'Create or delete a Cloud Scheduler job for daily orphaned RegisteredModel cleanup'
    ...
    def handle(self, *args, **options):
        ...
        webhook_url = f"{base_url}/api/system/cleanup-orphan-models-webhook/"
        ...
        try:
            ...
            try:
                ...
                self.stdout.write(self.style.SUCCESS(
                    ...
                    f'  Schedule: {SCHEDULE} (daily at 04:00 UTC)\n'
