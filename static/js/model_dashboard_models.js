...
const ModelDashboardModels = (function() {
    ...
    function generatePageButton(pageNum, currentPage) {
        ...
        return `<button onclick="ModelDashboardModels.goToPage(${pageNum})" class="w-8 h-8 flex items-center justify-center rounded-md text-sm font-medium border border-gray-300 hover:bg-blue-50 text-gray-700">${pageNum}</button>`;
    }
        ...
        return `
            <div class="flex flex-col sm:flex-row items-center justify-between mt-4 pt-4 border-t border-gray-200 gap-2">
                ...
                <div class="flex items-center gap-1">
                    <button onclick="ModelDashboardModels.prevPage()" ${!hasPrev ? 'disabled' : ''} class="px-3 py-1.5 border rounded-md text-sm font-medium ${hasPrev ? 'border-gray-300 hover:bg-blue-50 text-gray-700' : 'border-gray-200 text-gray-400 cursor-not-allowed'}">
                        Previous
                    </button>
                    <div class="flex items-center gap-1 mx-2">
                        ${pageButtons}
                    </div>
                    <button onclick="ModelDashboardModels.nextPage()" ${!hasNext ? 'disabled' : ''} class="px-3 py-1.5 border rounded-md text-sm font-medium ${hasNext ? 'border-gray-300 hover:bg-blue-50 text-gray-700' : 'border-gray-200 text-gray-400 cursor-not-allowed'}">
                        Next
                    </button>
                </div>
            </div>
